     ...
     <section id="testimonials" className="bg-[#0a0908] py-40 px-4 md:px-8">
      <div className="text-white text-center">
        <h4 className="text-white text-4xl lg:text-5xl font-[Caveat] ">
          <span>
            <span className="text-[#f6953a]">W</span>hat{' '}
            <span className="text-[#f6953a]">O</span>ther{' '}
            <span className="text-[#f6953a]">P</span>eople{' '}
            <span className="text-[#f6953a]">S</span>ay
          </span>
        </h4>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <p className="my-4 text-[#f6953a]">{person.role}</p>
